...
public class ScramSHA512PlusMechanism
		extends ScramPlusMechanism {

	public ScramSHA512PlusMechanism() {
		super("SCRAM-SHA-512-PLUS", "SHA-512", "Client Key".getBytes(UTF_CHARSET), "Server Key".getBytes(UTF_CHARSET));
	}
